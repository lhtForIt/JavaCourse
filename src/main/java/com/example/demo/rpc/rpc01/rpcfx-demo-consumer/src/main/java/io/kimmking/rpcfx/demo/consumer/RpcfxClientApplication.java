...
public class RpcfxClientApplication {
	...
	public static void main(String[] args) {
		...
		UserService userService = Rpcfx.create(UserService.class, "http://localhost:8080/", "leo", "1.0.0");
		User user = userService.findById(1);
		System.out.println("find user id=1 from server: " + user.getName());

		OrderService orderService = Rpcfx.create(OrderService.class, "http://localhost:8080/", "peipei", "2.0.0");
